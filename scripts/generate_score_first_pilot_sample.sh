...
DEFAULT_ADAPTER_DIR="$RUN_ROOT/10_variation_repair_refinement/adapter"
if [[ ! -d "$DEFAULT_ADAPTER_DIR" ]]; then
  DEFAULT_ADAPTER_DIR="$RUN_ROOT/09_two_staff_refinement/adapter"
fi
ADAPTER_DIR=${MIDI_LLM_SAMPLE_ADAPTER_DIR:-"$DEFAULT_ADAPTER_DIR"}
